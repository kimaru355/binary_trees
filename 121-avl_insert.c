 ...
 * @tree: type **pointer of the_root node of the AVL tree struct.
 * @parent: parent node of struct AVL.
 * @new: type**pointer left or right insertion.
 * @nval: insertion value of the AVL.
 * Return: pointer to the new the_root after insertion otherwise NULL
 */
 ...
 * @tree: type **pointer to the the_root node of the AVL tree to insert into.
